...
/*   Updated: 2022/06/14 12:18:21 by bdetune          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3D.h"

static void	init_toggle_door(t_info *info, t_proj *proj)
{
	proj->door = NULL;
...
static void	door_in_range(t_info *info, t_proj *proj)
{
	int		coords[2];
...
void	toggle_door(t_info *info)
{
	...
	init_toggle_door(info, &proj);
	door_in_range(info, &proj);
	if (proj.door)
	{
...
void	door_next_position(t_door *current)
{
